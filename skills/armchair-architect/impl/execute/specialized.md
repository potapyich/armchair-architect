# Impl: Specialized Executor

## Overview

Extends the built-in executor with role-aware subagent prompts for parallel task dispatch.
...
Follow all instructions in `${CLAUDE_SKILL_DIR}/impl/execute/default.md`, with one
...
code review gate, context budget awareness, completion — is identical to default.md.
